...
def legacy_switch_name_finder(file_name):
    ...
    with open(file_name) as netDB_file:
        for i in netDB_file:
            list_of_i = i.split(",")
            if list_of_i[0] != "" and list_of_i[0] != "Switch" and list_of_i[0] != "Legacy Switch"and legacy_switch_name == "":
                ...
                if match_count == 1:
                    if "Hewlett Packard" or "Dell Inc" in matches:
                        ...
                        if phone_lap[7] == "":
                            ...
                            if "c8:4c:75" in phone_lap or "c8:4c:75" in matches[1][7]:
                ...
                with open(port_file_name) as patch_panel:
                    ...
                    for k in patch_panel:
                        ...
                        if list_of_k[1] == list_of_i[2] and list_of_i[3] == "":
                            ...
                            if "AS-".lower() in list_of_k[5]:
                                switch_num = "Switch " + list_of_k[5][list_of_k[5].find("AS-".lower())+3]

                            elif "AS-".upper() in list_of_k[5]:
                                switch_num = "Switch " + list_of_k[5][list_of_k[5].find("AS-".upper())+3]
                            ...
                            elif "B".upper() in list_of_k[5]:
                                if list_of_k[5].find("AS".lower()) > list_of_k[5].find("B".lower()):
                                    blade_num = list_of_k[5][list_of_k[5].find("B".upper()):list_of_k[5].find("AS".lower())]

                                elif list_of_k[5].find("AS".upper()) > list_of_k[5].find("B".lower()):
                                    blade_num = list_of_k[5][list_of_k[5].find("B".upper()):list_of_k[5].find("AS".upper())]

                                else:
                                    blade_num = list_of_k[5][list_of_k[5].find("B".upper()):]

                            elif list_of_k[5] == "" or "b" not in list_of_k[5] or "B" not in list_of_k[5]:
